...
function begin_play(){
	...
	if (isEmpty(document.getElementById("player1_id").value) || isEmpty(document.getElementById("player2_id").value)){
		...
		started = true;
		document.getElementById("turn_info").innerHTML = "Turn for: " + player1txt.bold();
		document.getElementById("player1_id").disabled = "disabled";
		document.getElementById("player2_id").disabled = "disabled";
...
function reset_play(){
	...
	document.getElementById("player1_id").disabled = null;
	document.getElementById("player2_id").disabled = null;
...
*/
function validate_table(board_state){
...
function play() {
	...
	else if (!(document.getElementById("move_text_id").value == "A1" || document.getElementById("move_text_id").value == "A2" || document.getElementById("move_text_id").value == "A3" || document.getElementById("move_text_id").value == "a1" || document.getElementById("move_text_id").value == "a2" || document.getElementById("move_text_id").value == "a3" || document.getElementById("move_text_id").value == "B1" || document.getElementById("move_text_id").value == "B2" || document.getElementById("move_text_id").value == "B3" || document.getElementById("move_text_id").value == "b1" || document.getElementById("move_text_id").value == "b2" || document.getElementById("move_text_id").value == "b3" || document.getElementById("move_text_id").value == "C1" || document.getElementById("move_text_id").value == "C2" || document.getElementById("move_text_id").value == "C3" || document.getElementById("move_text_id").value == "c1" || document.getElementById("move_text_id").value == "c2" || document.getElementById("move_text_id").value == "c3")){
		alert("invalid move");
		return;
	}
	else{
		if(board_state[table_ids.indexOf(document.getElementById("move_text_id").value)] != -1){
			alert("invalid move");
			return;
		}
		if(whose_move()){
			document.getElementById(document.getElementById("move_text_id").value).innerHTML = "X";
			board_state[table_ids.indexOf(document.getElementById("move_text_id").value)] = 1;
			document.getElementById("turn_info").innerHTML = "Turn for: " + player2txt.bold();
			console.log(board_state);
		}
		if(!whose_move()){
			document.getElementById(document.getElementById("move_text_id").value).innerHTML = "O";
			board_state[table_ids.indexOf(document.getElementById("move_text_id").value)] = 0;
			document.getElementById("turn_info").innerHTML = "Turn for: " + player1txt.bold();
			console.log(board_state);
		}
		validate_table(board_state);
	}
	toggle_move();
}
